...
module.exports = {
    ...PRODUCTION_CONFIG,
    "datastores": {
        ...PRODUCTION_CONFIG.datastores,
        "default": {
            ...PRODUCTION_CONFIG.datastores.default, // url: 'mysql://shared:some_password_everyone_knows@db.example.com:3306/my_staging_db',
            // --------------------------------------------------------------------------
